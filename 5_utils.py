...
def bmp_to_png(source_folder, target_folder):
    ...
    for filename in os.listdir(source_folder):
        if filename.endswith('.bmp') or filename.endswith('.BMP'):
            ...
            target_file_path = os.path.join(target_folder, filename[:-4]+".png")
...
if __name__ == "__main__":
    ...
    source_folder = "testpic"
    target_folder = "testpic"
    bmp_to_png(source_folder, target_folder)